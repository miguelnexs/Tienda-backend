#!/usr/bin/env python3
"""
Script para verificar la configuración de producción en Render
"""
import os
import sys
import django
...
def test_cloudinary_production():
    ...
    try:
        ...
        cloudinary.uploader.destroy('test_production')
...
def test_storage_production():
    ...
    try:
        ...
        # Crear ContentFile
        content = ContentFile(img_io.getvalue(), name='test_storage_production.png')
        
        # Guardar usando storage
        saved_name = default_storage.save('test_storage_production.png', content)
...
if __name__ == "__main__":
    ...
    if all([config_success, cloudinary_success, storage_success]):
