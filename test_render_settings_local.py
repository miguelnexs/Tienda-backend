#!/usr/bin/env python3
"""
Script para probar la configuración de render_settings.py localmente
"""
import os
import sys
import django
...
try:
    ...
    # Intentar con settings locales
    print("🔄 Intentando con settings locales...")
    os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'Backend.settings')
    try:
        django.setup()
        print("✅ Django configurado con settings locales")
    except Exception as e2:
        print(f"❌ Error configurando Django con settings locales: {e2}")
        sys.exit(1)
...
if __name__ == "__main__":
    print("🚀 INICIANDO PRUEBA DE RENDER_SETTINGS (LOCAL)")
    print("=" * 60)
