#!/usr/bin/env python3
"""
Script de prueba para el storage directo de Cloudinary
"""
import os
import sys
import django
...
def test_direct_storage():
    """Probar el storage directo"""
    print("🔧 PROBANDO STORAGE DIRECTO")
    print("=" * 50)
    ...
    # Verificar si es DirectCloudinaryStorage
    if 'DirectCloudinaryStorage' in str(type(default_storage)):
        print("✅ Usando DirectCloudinaryStorage")
    else:
        print("❌ No usando DirectCloudinaryStorage")
...
def test_upload():
    ...
    try:
        ...
        # Subir archivo
        test_name = 'test_direct_storage.png'
...
def test_model_upload():
    ...
    try:
        ...
        categoria = CategoriaProducto.objects.create(
            nombre="Test Direct Storage",
            descripcion="Prueba del storage directo",
            orden=995
        )
        ...
        # Subir imagen
        with open(temp_file_path, 'rb') as f:
            django_file = File(f, name='test_direct_model.png')
            categoria.imagen.save('test_direct_model.png', django_file, save=True)
...
def main():
    """Función principal"""
    print("🔍 PRUEBA DEL STORAGE DIRECTO")
    print("=" * 60)
